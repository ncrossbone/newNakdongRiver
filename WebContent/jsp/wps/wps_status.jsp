...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/wps_status.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/wps/wps_status_view.js').wait(function() {
				pageView = new wpsStatusView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/wps/wps_status_map.js').wait(function() {
				pageMap = new wpsStatusMap();
				pageMap.init();
			});
    </script>
</head>
...
<body class="claro">
	...
	<!-- timeLayer1 start -->
	<!--div id="timeLayer1Min"></div>
	<div id="timeLayer1Max">
		<div class="row1">
			<div id="timeLayerBtnStart"></div>
			
			<div id="timeLayerBtnStop"></div>
		</div>
		<div class="row2" id="timeLayer1Slider">
			<div class="left"></div>
			<div class="bar"></div>
			<div class="right"></div>
			<div class="value">1월</div>
		</div>
	</div-->
	<!-- timeLayer1 end -->
