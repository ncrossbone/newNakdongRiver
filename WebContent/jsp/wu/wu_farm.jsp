...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/wu_farm.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/wu/wu_farm_view.js').wait(function() {
				pageView = new wuFarmView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/wu/wu_farm_map.js').wait(function() {
				pageMap = new wuFarmMap();
				pageMap.init();
			});
    </script>
</head>
