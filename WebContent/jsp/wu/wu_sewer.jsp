...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/wu_sewer.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/wu/wu_sewer_view.js').wait(function() {
				pageView = new wuSewerView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/wu/wu_sewer_map.js').wait(function() {
				pageMap = new wuSewerMap();
				pageMap.init();
			});
    </script>
</head>
