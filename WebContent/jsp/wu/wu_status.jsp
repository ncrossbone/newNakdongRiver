...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/wu_status.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/wu/wu_status_view.js').wait(function() {
				pageView = new wuStatusView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/wu/wu_status_map.js').wait(function() {
				pageMap = new wuStatusMap();
				pageMap.init();
			});
    </script>
</head>
