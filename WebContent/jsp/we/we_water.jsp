...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/we_water.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/we/we_water_view.js').wait(function() {
				pageView = new weWaterView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/we/we_water_map.js').wait(function() {
				pageMap = new weWaterMap();
				pageMap.init();
			});
    </script>
</head>
