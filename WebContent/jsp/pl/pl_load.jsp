...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/pl_load.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/pl/pl_load_view.js').wait(function() {
				pageView = new plLoadView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/pl/pl_load_map.js').wait(function() {
				pageMap = new plLoadMap();
				pageMap.init();
			});
    </script>
</head>
...
<body class="claro">
	...
	<div id="searchMax">
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="value">
					<select id="search_type_type">
						<option value="none" selected="selected">구분 선택</option>
						<option value="01">생활계</option>
						<option value="02">축산계</option>
						<option value="03">산업계</option>
						<option value="04">토지계</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="type">부하량</td>
				<td class="value">
					<select id="search_type_buha">
						<option value="none" selected="selected">부하량 선택</option>
						<option value="01">발생부하량</option>
						<option value="02">배출부하량</option>						
					</select>
				</td>
			</tr>
			<tr>
