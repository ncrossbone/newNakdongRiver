...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/pl_develop.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/pl/pl_develop_view.js').wait(function() {
				pageView = new plDevelopView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/pl/pl_develop_map.js').wait(function() {
				pageMap = new plDevelopMap();
				pageMap.init();
			});
    </script>
</head>
