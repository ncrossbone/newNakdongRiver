...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/pl_rate.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/pl/pl_rate_view.js').wait(function() {
				pageView = new plRateView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/pl/pl_rate_map.js').wait(function() {
				pageMap = new plRateMap();
				pageMap.init();
			});
    </script>
</head>
			...
			<tr>
				...
				<td class="value">
					<select id="search_type_sw">
						<option value="none" selected="selected">소권역선택</option>
					</select>
				</td>
			</tr>
			<tr>
