...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/db_river.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/db/db_river_view.js').wait(function() {
				pageView = new dbRiverView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/db/db_river_map.js').wait(function() {
				pageMap = new dbRiverMap();
				pageMap.init();
			});
    </script>
</head>
