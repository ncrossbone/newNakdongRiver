...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/db_status.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/db/db_rainriver_view.js').wait(function() {
				pageView = new dbStatusView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/db/db_rainriver_map.js').wait(function() {
				pageMap = new dbStatusMap();
				pageMap.init();
			});
...
<!-- 			<tr> -->
<!-- 				<td class="group" rowspan="2"><input type="radio" name="searchGroup" value="1"></td> -->
...
<!-- 			</tr> -->
<!-- 			<tr> -->
<!-- 				<td class="type">소권역</td> -->
<!-- 				<td class="value"> -->
<!-- 					<select id="search_type_sw"> -->
<!-- 						<option value="none" selected="selected">소권역 선택</option> -->
<!-- 					</select> -->
<!-- 				</td> -->
<!-- 			</tr> -->
<!-- 			<tr> -->
...
<!-- 	</div>  -->
	...
	<!-- toc start -->
	<div id="tocMin" style="left: 20px;"></div>
	<div id="tocMax">
		<div class="toolbar">
			<!-- 레이어 투명도 -->
			<div class="opacity">
