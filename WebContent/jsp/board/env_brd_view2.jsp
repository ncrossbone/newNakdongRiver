        ...
        <div id="sub_contents">
            ...
            <ul class="list">
                    ...
                    <li class="on"><a href="/nakdong/envBrd.do">환경기초조사사업</a></li>
                      <ul class="dep2">
                            <li><a href="/nakdong/envBrd.do">- 1단계 보고서</a></li>
                            <li class="dep_on">- 2단계 보고서</li>
						  </ul>
         ...
         <div id="page">
            ...
            <h2>환경기초조사사업</h2>
            <h4>환경기초조사사업 2단계 보고서 관련된 데이터를 확인하실 수 있습니다.</h4>
           <div class="board_form">
                ...
                <div class="pagination">
               	  <div class="bt_wr"><a href="/nakdong/envBrd2.do">목록</a></div>
               	  <%if("관리자".equals(USER_NM)){ %>
                    <div class="bt_wr"><a href="javascript:deleteBoard()">삭제</a></div>
                    <div class="bt_wr"><a href="/nakdong/envBrdWrite2.do?BOARD_SEQ=<%=BOARD_SEQ%>">수정</a></div>
                  <%}%>
                </div>
...
function set_data(dataList){
	...
	document.getElementById("RES_YEAR").innerHTML = RES_START_DATE+" ~ "+  RES_END_DATE;
...
$.ajax({
	...
	if (msg == 'success') {
	alert("삭제되었습니다.")				
	document.form1.action = "/nakdong/envBrd2.do";
