                ...
                <div class="pagination">
                	<div class="bt_wr">
                	 <%if("관리자".equals(USER_NM)){ %>
                    	<a href="/nakdong/waterBrdWrite.do">글쓰기</a>
                     <%} %>
                    </div>
	...
	*/
			...
			function set_test(dataList){
				...
				$.each(dataList, function(index, json) {
						...
						resultHtml+="                   <td class='title_cont'><a href='/nakdong/waterBrdView.do?BOARD_SEQ="+json.BOARD_SEQ+"'>"+json.BOARD_TITLE+"</a></td> ";
						resultHtml+="                    <td>";
						if(json.FILE_NAME != null && "" != json.FILE_NAME){
							resultHtml+="<center><a href='/nakdong/upload/"+json.REAL_FILE_PATH+"'><span class='file_"+json.FILE_NAME.substring(json.FILE_NAME.lastIndexOf(".")+1,json.FILE_NAME.lastIndexOf(".")+4)+"'></span></a></center>";
						}
						/*
						if(json.FILE_NAME != null && "" != json.FILE_NAME){
						...
						*/
						...
						resultHtml+="                    <td><center>"+json.READ_CNT+"</center></td> ";
						resultHtml+="             </tr> ";
