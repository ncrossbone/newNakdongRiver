...
// 					$("#navi_title_img3").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_3_1.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 오염원/오염부하량 > 오염원");
...
// 					$("#navi_title_img3").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_3_2.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 오염원/오염부하량 > 배출업소");
...
// 					$("#navi_title_img1").hide();
// 					$("#navi_title_img2").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_3_3.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 오염원/오염부하량 > 부하량");
...
<!-- warp 시작 -->
	...
	<form name="adminmd" id="adminmd" method="post">
		<input type="hidden" id="L_CODE" name="L_CODE" value="03"/>
...
<!-- 			<a href="/admin.do" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('Image14','','/nakdong/resources/images/admin/sub_topmenu_1_1_over.png',1);"><img src="/nakdong/resources/images/admin/sub_topmenu_1_1_off.png" name="Image14" width="92" height="33" border="0"></a> -->
...
<!-- 			<img src="/nakdong/resources/images/admin/sub_topmenu_1_3_over.png" width="161" height="33"> -->
<!-- 			<a href="/admin4.do" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('Image13','','/nakdong/resources/images/admin/sub_topmenu_1_4_over.png',1);"><img src="/nakdong/resources/images/admin/sub_topmenu_1_4_off.png" name="Image13" width="92" height="33" border="0"></a> -->
<!-- 		</div> -->
<!-- 	</div> -->
...
<!-- 	    				<a href="/admin.do"><img src="/nakdong/resources/images/admin/left_menu_1_1_off.gif" width="65" height="17"></a><br/> -->
...
<!-- 	  					<img src="/nakdong/resources/images/admin/left_menu_1_3_over.gif" width="146" height="17" border="0"> -->
<!-- 							<li> -->
<!-- 	    						<a href="javascript:abcd('01');">오염원</a><br/> -->
<!-- 	      						<a href="javascript:abcd('02');">배출업소</a><br/> -->
<!-- 	      						<a href="javascript:abcd('03');">부하량</a> -->
<!-- 							</li> -->
<!-- 					</div> -->
<!-- 	  				<div id="left_menu_division_line"></div> -->
<!-- 	  				<div id="left_menu_4_off"> -->
<!-- 	  					<a href="/admin4.do"><img src="/nakdong/resources/images/admin/left_menu_1_4_off.gif" width="46" height="17" border="0"></a> -->
<!-- 					</div> -->
<!-- 	  				<div id="left_menu_division_line"></div> -->
<!-- 	  			</div> -->
<!-- 	  		</div> -->
...
<div id="left_menu_frame">
  ...
  <img src="/nakdong/resources/images/admin/left_menu_top_text.gif" width="305" height="48">
    <ul>
        ...
        <li>
			<a href="javascript:abcd('01');"><img src="/nakdong/resources/images/admin/left_menu_1_3_over.gif" width="146" height="17" border="0"></a>
		</li>
		<div class="depth_2" id="left_menu_1_over" style="display:block;">
			<b><a href="javascript:abcd('01');">오염원</a></b><br>
          	<a href="javascript:abcd('02');">배출업소</a><br>
          	<a href="javascript:abcd('03');">부하량</a>
        </div>
		<div class="depth_2" id="left_menu_2_over" style="display:none;">
			<a href="javascript:abcd('01');">오염원</a><br>
          	<b><a href="javascript:abcd('02');">배출업소</a></b><br>
          	<a href="javascript:abcd('03');">부하량</a>
        </div>
		<div class="depth_2" id="left_menu_3_over" style="display:none;">
			<a href="javascript:abcd('01');">오염원</a><br>
          	<a href="javascript:abcd('02');">배출업소</a><br>
          	<b><a href="javascript:abcd('03');">부하량</a></b>
        </div>
...
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_3_1.gif" width="52" height="30"> -->
<!-- 			</div> -->
<!-- 			<div id="navi_title_img2" style="display:none;"> -->
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_3_2.gif" width="70" height="30"> -->
<!-- 			</div> -->
<!-- 			<div id="navi_title_img3" style="display:none;"> -->
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_3_3.gif" width="100" height="30"> -->
<!-- 			</div> -->
...
<div id="contents">
	<div class="con_Nav">					
		<div id="navi_title_img" style="display:block;" class="here"><img src="/nakdong/resources/images/admin/sub_title_3_1.gif"></div>
		<div id="navi_path" class="navi">HOME > 관리자모드 > 오염원/오염부하량 > 오염원</div>
	</div>
