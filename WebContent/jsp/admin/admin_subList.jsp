...
// 						row +='<th class="bbs_w_list">아이디</th>';
...
// 						row +='</tr>';
// 						row +='<tr>';
// 						row +='<th class="bbs_w_list" stlye="width:30%;">최초등록아이디</th>';
// 						row +='<td  bgcolor="FFFFFF" style="text-align:left;width:70%;">'+json.CREATE_ID+'</td>';
// 						row +='</tr>';
// 						row +='<tr>';
// 						row +='<th class="bbs_w_list">최종등록아이디</th>';
...
// 						row +='</tr>';
						...
						row +='<tr>';						
						row +='<th class="modify_top_title_2">아이디</th>';
						...
						row +='</tr>';
						row +='<tr>';
						row +='<th class="modify_top_2" stlye="width:30%;">최초등록아이디</th>';
						row +='<td class="view_top_file_2">'+json.CREATE_ID+'</td>';
						row +='</tr>';
						row +='<tr>';
						row +='<th class="modify_top_2">최종등록아이디</th>';
						row +='<td class="view_top_file_2">'+json.CREATE_ID+'</td>';
						row +='</tr>';
						row +='<tr>';
						row +='<th class="modify_top_2">최종등록아이디</th>';
						...
						row +='</tr>';
						row +='<tr>';
// 						row +='<th class="modify_top_2">비고</th>';
...
<!-- 		<div align="right"> -->
<!-- 			<a href="#" onclick="javascript:modify(USER_ID);"><img src="/nakdong/resources/images/admin/bt_modify.gif" alt="수정"/></a> -->
