...
<%@ include file="/jsp/admin/admin_session_inc.jsp" %>
...
// 		alert("id:left_menu_1_over 클릭시"+tmpSrc);
...
// 					$("#navi_title_img3").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_1_1.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 측정자료 > 수질");
...
// 					$("#navi_title_img3").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_1_2.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 측정자료 > 수생태");
...
// 					$("#navi_title_img1").hide();
// 					$("#navi_title_img2").hide();
					$("#navi_title_img").html('<img src="/nakdong/resources/images/admin/sub_title_1_3.gif">');
					
					$("#navi_path").html("HOME > 관리자모드 > 측정자료 > 수리/수문");
...
<!-- warp 시작 -->
	...
	<form name="adminmd" id="adminmd" method="post">
			<input type="hidden" id="L_CODE" name="L_CODE" value="01"/>
...
<!-- 			<img src="/nakdong/resources/images/admin/sub_topmenu_1_1_over.png" width="92" height="33"> -->
...
<!-- 	    				<a href = "javascript:abcd('01');"> -->
<!-- 						<img src="/nakdong/resources/images/admin/left_menu_1_1_over.gif" width="65" height="17"></a><br/> -->
<!-- 	    				<li> -->
<!-- 	    					<a href="javascript:abcd('01');">수질</a><br/> -->
<!-- 	      					<a href="javascript:abcd('02');">수생태</a><br/> -->
<!-- 	      					<a href="javascript:abcd('03');">수리/수문</a> -->
<!-- 						</li> -->
<!-- 	    			</div> -->
...
<div id="left_menu_frame">
  ...
  <img src="/nakdong/resources/images/admin/left_menu_top_text.gif" width="305" height="48">
    ...
    <ul>
		<li>
			<a href="javascript:abcd('01');"><img src="/nakdong/resources/images/admin/left_menu_1_1_over.gif" width="65" height="17" border="0"></a>
		</li>
		<div class="depth_2" id="left_menu_1_over" style="display:block;">
			<b><a href="javascript:abcd('01');">수질</a></b><br>
          	<a href="javascript:abcd('02');">수생태</a><br>
          	<a href="javascript:abcd('03');">수리/수문</a>
        </div>
		<div class="depth_2" id="left_menu_2_over" style="display:none;">
			<a href="javascript:abcd('01');">수질</a><br>
          	<b><a href="javascript:abcd('02');">수생태</a></b><br>
          	<a href="javascript:abcd('03');">수리/수문</a>
        </div>
		<div class="depth_2" id="left_menu_3_over" style="display:none;">
			<a href="javascript:abcd('01');">수질</a><br>
          	<a href="javascript:abcd('02');">수생태</a><br>
          	<b><a href="javascript:abcd('03');">수리/수문</a></b>
        </div>
		<li onclick="javascript:location.href='/nakdong/admin2.do';" id="left_menu_2_off" style="cursor:hand;"><img src="/nakdong/resources/images/admin/left_menu_1_2_off.gif" width="65" height="17"></li>
...
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_1_1.gif" width="52" height="30"> -->
<!-- 			</div> -->
<!-- 			<div id="navi_title_img2" style="display:none;"> -->
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_1_2.gif" width="70" height="30"> -->
<!-- 			</div> -->
<!-- 			<div id="navi_title_img3" style="display:none;"> -->
<!-- 				<img src="/nakdong/resources/images/admin/sub_title_1_3.gif" width="100" height="30"> -->
<!-- 			</div> -->
...
<div id="contents">
	<div class="con_Nav">
		<div id="navi_title_img" class="here"><img src="/nakdong/resources/images/admin/sub_title_1_1.gif"></div>
