...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/nakdong/resources/css/custom/etf_status.css">
    ...
    <script type="text/javascript">
		...
		$LAB
			...
			.script('/nakdong/resources/js/custom/etf/etf_status_view.js').wait(function() {
				pageView = new etfStatusView();
				pageView.init();
			})
			.script('/nakdong/resources/js/custom/etf/etf_status_map.js').wait(function() {
				pageMap = new etfStatusMap();
				pageMap.init();
			});
    </script>
</head>
...
<body class="claro">
	...
	<div id="searchMax">
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="group"><input type="radio" name="searchGroup" value="1"></td>
			...
			<tr>
				<td class="group" rowspan="2"><input type="radio" name="searchGroup" value="2"></td>
				<td class="type">시도</td>
				<td class="value">
			...
			<tr>
				<td class="type">시군구</td>
				<td class="value">
					<select id="search_type_sgg">
						<option value="none" selected="selected">시군구 선택</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="group"></td>
				<td class="type">시설종류</td>
				<td class="value">
					<select id="search_type_type">
						<option value="none" selected="selected">환경기초시설 선택</option>
						<option value='S'>축산폐수공공처리시설</option>
						<option value='W'>하수종말처리시설</option>
						<option value='I'>산업폐수종말처리시설</option>
						<option value='F'>분뇨처리시설</option>
						<option value='V'>마을하수도</option>
						<option value='A'>농공단지처리시설</option>
						<option value='H'>기타공동처리시설</option>
					</select>
				</td>
			</tr>
			<tr>
