...
//		setQueryTask2();
	...
	//수질현황지점 레이어 - mapserver에 query 요청
...
//				else { num = 7; text = '측정값 없음'; }
			...
			case 'TP':
				if(value <= 0.02) {num = 0; text = '매우좋음'; }
				else if(value > 0.02 && value <= 0.04) { num = 1; text = '좋음'; }
				else if(value > 0.04 && value <= 0.1) { num = 2; text = '약간좋음'; }
				else if(value > 0.1 && value <= 0.2) { num = 3; text = '보통'; }
				else if(value > 0.2 && value <= 0.3) { num = 4; text = '약간나쁨'; }
				else if(value > 0.3 && value <= 0.5) { num = 5; text = '나쁨'; }
				else if(value > 0.5) { num = 6; text = '매우나쁨'; }
//				else { num = 7; text = '측정값 없음'; }
