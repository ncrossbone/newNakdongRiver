					...
					items: [{
						...
						items: [{
							...
							items: [{
								...
								axes: [{
									...
									type: 'Numeric',
									fields: ['RN_DAY_AVG', 'RN_DAY_MAX', 'RN_DAY_MIN'],
									position: 'left',
									grid: true,
									label: {
								...
								series: [
		                        	{
			                            ...
			                            tips: {
			                            	...
			                            	renderer: function(storeItem, item) {
			                            		...
			                            		var value = storeItem.get('RN_DAY_AVG');
			                            ...
			                            tips: {
			                            	...
			                            	renderer: function(storeItem, item) {
			                            		var name = storeItem.get('YEAR');
			                            		var value = storeItem.get('RN_DAY_MAX');
			                            ...
			                            tips: {
			                            	...
			                            	renderer: function(storeItem, item) {
			                            		var name = storeItem.get('YEAR');
			                            		var value = storeItem.get('RN_DAY_MIN');
								...
								listeners: {
									render: {
										fn: function(me){
											...
											proxy.extraParams = {
												weathercode: request.getParameter('weathercode')
											};
								...
								series: [
		                        	{
			                            ...
			                            tips: {
			                            	...
			                            	renderer: function(storeItem, item) {
			                            		...
			                            		var value = storeItem.get('RN_DAY');
						...
						tbar: [
							{
								...
								handler: function() {
									...
									for(var i in data) {
										...
										html += "<td>" + data[i].data['RN_DAY_AVG'] + "</td>";
										html += "<td>" + data[i].data['RN_DAY_MAX'] + "</td>";
										html += "<td>" + data[i].data['RN_DAY_MIN'] + "</td>";
										html += "</tr>";
									}
						...
						items: [{
							...
							columns: [{
								...
								xtype: 'gridcolumn',
								dataIndex: 'RN_DAY_AVG',
								header: '평균',
								flex: 1,
								align: 'right'
							}, {
								xtype: 'gridcolumn',
								dataIndex: 'RN_DAY_MAX',
								header: '최대',
								flex: 1,
								align: 'right'
							}, {
								xtype: 'gridcolumn',
								dataIndex: 'RN_DAY_MIN',
								header: '최소',
								flex: 1,
								align: 'right'
							}],
