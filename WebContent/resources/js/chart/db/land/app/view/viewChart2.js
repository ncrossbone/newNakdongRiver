...
//															
//															if(text == 'DRY') me.legend.items[i].items[0].attr.text = '시가화/건조지역';
//															else if(text == 'RIC') me.legend.items[i].items[0].attr.text = '논';
//															else if(text == 'FLD') me.legend.items[i].items[0].attr.text = '밭';
//															else if(text == 'FRST') me.legend.items[i].items[0].attr.text = '산림';
//															else if(text == 'MDW') me.legend.items[i].items[0].attr.text = '초지';
//															else if(text == 'SWMP') me.legend.items[i].items[0].attr.text = '습지';
//															else if(text == 'VCT') me.legend.items[i].items[0].attr.text = '나지';
//															else if(text == 'WZN') me.legend.items[i].items[0].attr.text = '수역';
//															
//														}
